...
import { Dialog, Classes, Spinner, NonIdealState, Callout, Button, H5, Tooltip, Tag, Intent, Tabs, Tab, Collapse, Alert } from '@blueprintjs/core';
  ...
  const handleDeleteConfirm = () => {
    ...
    deleteMutation.mutate(filePath, {
      onSuccess: () => {
        ...
        onClose();
        showToaster({ message: `File "${fileName}" deleted`, intent: Intent.DANGER, icon: 'trash', timeout: 3000 });
      },
      onError: (err: any) => {
        setIsDeleteConfirmOpen(false);
      ...
      >
        ...
        <div className={Classes.DIALOG_FOOTER}>
          <div className={Classes.DIALOG_FOOTER_ACTIONS}>
            <Button icon="trash" intent={Intent.DANGER} onClick={() => setIsDeleteConfirmOpen(true)}>
              Delete File
            </Button>
